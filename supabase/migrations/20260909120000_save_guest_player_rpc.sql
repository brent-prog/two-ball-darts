create or replace function public.save_two_ball_guest(
...
revoke all on function public.save_two_ball_guest(text,text) from public;
grant execute on function public.save_two_ball_guest(text,text) to anon, authenticated;
